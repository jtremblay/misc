...
use Getopt::Long;
use lib "/house/homedirs/t/tremblay/myscripts/itagger/libs/";
...
my $usage=<<'ENDHERE';
NAME:
    generate_RDP_taxonomy_from_fasta.pl
PURPOSE:
...
my $fasta_db = JGI::Bio::Iterator::FastaDb->new($fasta) or die("Unable to open Fasta file, $fasta\n");
